...
- Pico-key, a proof of concept showcasing keystroke injection on a target machine to get a keylogger, allowing an attacker to perform recon on a target with only one device
